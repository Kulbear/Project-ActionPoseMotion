...
def parse_args():
    ...
    parser.add_argument('--final', default=0, type=int,
    ...
    parser.add_argument('-ts', '--time_stride', default=2, type=int,
    ...
    parser.add_argument('-ws', '--window_stride', default=4, type=int,
