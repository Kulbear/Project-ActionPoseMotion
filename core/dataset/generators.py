...
class PoseGenerator(Dataset):
    def __init__(self, pose_2d_past, pose_2d_gt_past, pose_3d_past, pose_3d_future,
                 pose_3d_lie, pose_3d_future_lie, actions):
        self._pose_2d_past = np.array(pose_2d_past)
        self._pose_2d_gt_past = np.array(pose_2d_gt_past)
        ...
        assert len(self._pose_2d_gt_past) == len(self._pose_lie)
    ...
    def __getitem__(self, index):
        ...
        out_2d_gt_past = torch.from_numpy(self._pose_2d_gt_past[index]).float()
